...
export const SubscriptionTitle = ({
  ...
  return (
    <div
      className={`subscription-title bg-white shadow-sm shadow-grey-300 text-center mt-0 mx-4 mb-auto pt-5 pb-px border-y-auto z-1 row-start-1 row-end-2 tablet:mx-0 ${className}`}
      data-testid={`subscription-${screenType}-title`}
    >
      <Localized id={`subscription-${screenType}-title`}>
        <h3 className="font-semibold leading-8 mb-2 text-grey-600 text-xl">{titles[screenType]}</h3>
      </Localized>
